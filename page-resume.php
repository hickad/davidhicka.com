...
?>
    <div class="main-wrapper">
        <div class="container resume-container px-3 px-lg-5">
            <article class="resume-wrapper mx-auto theme-bg-light p-4 p-md-5 mb-2 my-3 my-lg-5 shadow-lg">
                    ...
                    <div class="row">
                        <div class="resume-main col-12 pe-0">
                            <section class="work-section py-3">
                                ...
                                <div class="item mb-3">
                                    <div class="item-heading row align-items-center mb-2">
                                        ...
                                        <div class="item-meta col-12 col-md-6 col-lg-6 text-muted text-start text-md-end">Advanced Business Computers of America – Jacksonville, FL | December 2017 – November 2019</div>
                                    </div>
                                    <div class="item-content">
                                        <ul class="resume-list">
                                ...
                                <div class="item mb-3">
                                    <div class="item-heading row align-items-center mb-2">
                                        ...
                                        <div class="item-meta col-12 col-md-6 col-lg-4 text-muted text-start text-md-end">Florida Blue – Jacksonville, FL | April 2017 – September 2017</div>
                                    </div>
                                    <div class="item-content">
                                        <ul class="resume-list">
                            ...
                            <section class="education-section py-3">
                                ...
                                <div class="item">
                                    <div class="item-content">
                                        <h4 class="item-title">Bachelor of Applied Science (B.A.Sc.), Information Technology Management</h4>
                                        <div class="item-meta">Florida State College – Jacksonville, FL</div>
                                    </div>
                                </div><!--//item-->
