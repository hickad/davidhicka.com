...
<?php wp_footer(); ?>
    ...
    <div class="main-wrapper">
        <div class="container resume-container px-3 mb-3 px-lg-5">
            <footer>
                <div class="text-center">
                    <p class="text-center mb-1" style="font-size:.75em;">This site is protected by reCAPTCHA and the Google
